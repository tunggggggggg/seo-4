    ...
    <nav class="navbar">
        <div class="container nav-container">
            <a href="index.html" class="logo">
                <img src="assets/images/brand_logo*.png" alt="Meow Harmony Logo" id="nav-logo">
            </a>
            <ul class="nav-links">
    ...
    <footer>
        <div class="container footer-container">
            <div class="footer-col">
                <img src="assets/images/brand_logo*.png" alt="Meow Harmony Logo" class="footer-logo" id="footer-logo">
...
for filename, data in pages.items():
    with open(filename, "w", encoding="utf-8") as f:
        f.write(base_html.replace("{title}", data["title"]).replace("{content}", data["content"]))
